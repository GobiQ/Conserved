...
def main():
    ...
    # Organism-specific help information
    with st.expander("🧬 Organism-Specific Analysis Guide"):
        st.markdown("""
        **Understanding Results by Organism Type:**
        ...
        **🔬 Conservation Patterns in Viruses:**
